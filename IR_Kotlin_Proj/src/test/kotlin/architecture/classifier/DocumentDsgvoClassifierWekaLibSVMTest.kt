...
import architecture.document.classifier.DocumentDsgvoClassifierWekaLibSVM
...
@Deprecated("Weka is not used by the DsgvoAssitant. Liblinear SVM worked better.")
class DocumentDsgvoClassifierWekaLibSVMTest{
    ...
    fun testWithPositiveSample(){
        val classifier: DocumentDsgvoClassifier = DocumentDsgvoClassifierWekaLibSVM(
            vectorizer,
